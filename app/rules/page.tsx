          ...
          {language === "ru" ? (
            <>
              <p>
                ...
                , привязать TWITCH ACC и URL Steam Trade.
              </p>
              <p>
              ...
              <p>После начала отслеживания в MINI APP написать минимум одно сообщение в чате платформы стримера.</p>
            </>
          ) : (
            <>
              <p>
                ...
                , and link Twitch account + Steam Trade URL.
              </p>
              <p>
              ...
              <p>After tracking in the MINI APP, send at least one message in the streamer chat.</p>
            </>
          )}
        </div>
      </div>
