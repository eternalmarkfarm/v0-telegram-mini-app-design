import StreamerDetailClient from "./streamer-client";
...
export default function StreamerDetailPage({ params }: { params: { id: string } }) {
  return <StreamerDetailClient id={params.id} />;
}
